...
- **Then operator chooses among (post-18.2.2):**
  0. **Phase 18.2.1** (~3-5h CC OR Cowork) — Baltic palette retune across all cross-card consumers per spec P2-2 hex values vs Phase 18 shipped tokens; ~30+ files; cross-cutting per discipline rule #4
