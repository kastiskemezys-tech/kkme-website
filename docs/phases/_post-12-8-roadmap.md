...
- **Next CC pick — operator chooses among:**
  1. **Phase 7.7g-a-3** (~1-2 days CC) — typography rationalization + spacing residuals + per-side CI extension; addresses operator-surfaced "fonts all over the place" concern from earlier sessions; spec CC-1 + P3-1
