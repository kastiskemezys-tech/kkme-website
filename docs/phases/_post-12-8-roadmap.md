...
- ~~**Phase 36.B1 — Data audit + chronological hourly dispatch engine**~~ **[SHIPPED 2026-07-28, semi-autonomous (1 checkpoint)]** — branch `phase-36-b1-hourly-dispatch` (3 commits, head `9d10de9`) merged to main. Arc: `phase-36-b-arc.md` (bankable backend). Not deployed — nothing public changed; `/revenue` byte-identical at engine AND route layer (Session-88 lesson applied).
