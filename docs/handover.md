...
3. Apply roadmap delta to `docs/phases/_post-12-8-roadmap.md` (operator/Cowork-owned per discipline rule #5):
   - Phase 18.2.2 → Shipped appendix with full description
   - Phase 18.2.3 added as conditional candidate (visibility lift if post-merge feedback says "+" still hard to read)
