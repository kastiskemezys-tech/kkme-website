...
| B-037 | tech-debt | P3 | Fingrid API key unregistered | 2026-07-30 Phase 36.E | **decision, not a gap** | **Tabled 2026-08-03 Phase 46: this row did not exist** (filed in prose at ~:1069). Re-read at execution time: FI is not in the mature-market comparator set and no published figure depends on it, so an unregistered key is a scoping decision that was taken, not an outstanding task. Recorded as closed-by-decision rather than left reading as open work. |
